...
(function (factory) {
    ...
    Autocomplete.prototype = {
        ...
        initialize: function () {
            ...
            that.suggestionsContainer = Autocomplete.utils.createNode('<div class="' + options.containerClass + '" style="display:none; position: absolute; background-Color:#fff; border: 1px solid #999; padding:5px;"></div>');
        ...
        suggest: function () {
            ...
            $.each(that.suggestions, function (i, suggestion) {
                html += '<div class="' + className + '" data-index="' + i + '" style="border-bottom:1px solid #999; padding:7px;">' + formatResult(suggestion, value) + '</div>';
            });
